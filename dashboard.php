...
.btn-logout { background-color: #dc3545; border-color: #dc3545; color: #fff; }
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse">
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link btn btn-logout btn-sm ms-2" href="logout.php">Sair</a>
                </li>
            </ul>
        </div>
    </div>
...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="card p-4">
                <h5>Despesas</h5>
                <a href="custos.php" class="btn btn-primary w-100">Acessar</a>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="card p-4">
                ...
                <a href="ponto.php" class="btn btn-primary w-100">Calcular</a>
            </div>
        </div>
        <div class="col-md-6">
            <div class="card p-4">
                <h5>Relatórios</h5>
                <a href="relatorios.php" class="btn btn-primary w-100">Visualizar</a>
            </div>
        </div>
    </div>
</div>
